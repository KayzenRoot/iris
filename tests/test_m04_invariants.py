...
_CASE_BY_TARGET = {
    ...
    "unknown_mandatory_fails_closed": ("tests.test_m04_core", "SchemaAndSerializationBoundaryTests", "test_unknown_mandatory_schema_facet_and_extension_fail_closed"),
    "optional_opaque_policy": ("tests.test_m04_core", "SchemaAndSerializationBoundaryTests", "test_optional_unknown_facet_and_extension_require_explicit_opaque_policy"),
