...
## ADR-0039 - M06 implementation merged and exact-main validated
Status: `APPROVED`
IRIS-WO-0010 implemented the frozen `m06-contract-v1.0` provider-neutral Production State kernel. Independent audit first returned `CORRECTION REQUIRED` for 8 bounded semantic-safety findings covering availability binding, decision-scoped reuse, verification binding, cleanup race revalidation, release closure, rollback proof binding, equivalence proof and conservative frontier evolution. All findings were corrected in the same Work Order / PR and revalidated. Final audit approved exact head `84531decf8254aea242ef9e7fc1a94afe671de67` with 25/25 frozen families, 150/150 hard invariants indexed to executable proof targets, 20/20 versioned evidence ports, 8/8 synthetic profiles, 2770/2770 full-suite tests and zero residual HIGH/CRITICAL findings. PR #48 was squash-merged as `19f439837136cfd1e4882b085426ff6d91ad62f0`; exact-main Governance `35881369542 / 107250376754` passed with 2770/2770 tests. This post-merge reconciliation promotes that validated implementation into canonical checkpoint truth. M07 remains gated behind reconciliation merge, exact-main validation and its own bounded planning/admission flow.

## ADR-0040 - M07 planning frozen, merged and exact-main validated
Status: `APPROVED`
M07 Hardware Genome & Runtime Discovery completed S01-S05 planning, Final Technology Review and the M08-M60 Forward Compatibility Scan. The independent final planning audit approved `m07-contract-v1.0` with 235 frozen hard invariants, 20 independent mandatory technology surfaces, five mandatory absorbed components and zero residual HIGH/CRITICAL findings. Approved head `af79abb0e2eb072b8d4eeec33f923b5ccd9c9ff7` passed Governance `35885552243 / 107264667562` with 2770/2770 tests. PR #51 was squash-merged as `cbdf9071ca2980d4ff9823d7fbbd271cc15935b7`; exact-main Governance `35885688381 / 107265126344` passed with 2770/2770 tests. This records planning truth only. M07 implementation remains blocked until this post-merge reconciliation is merged/exact-main validated and a separate bounded implementation Work Order / Context Lock / Evidence package is admitted.

## ADR-0041 - M07 implementation merged and exact-main validated
Status: `APPROVED`
IRIS-WO-0011 implemented the frozen `m07-contract-v1.0` provider-neutral Hardware Genome & Runtime Discovery kernel. Independent implementation audit found two HIGH findings and zero CRITICAL findings: measured PCIe bandwidth had crossed into M08 empirical-performance authority, and the 20 mandatory technology surfaces referenced orphan proof-target labels. Both were corrected directly in PR #54. Final audited head `39ab5202e444641dfe17caf1bf1ebd16c975ebc5` passed Governance `35904907550 / 107330035212` with 2834/2834 tests and zero residual HIGH/CRITICAL findings. PR #54 was squash-merged as `a933a7abc8c553470737a5b558faa461708bac6f`; exact-main Governance `35905214414 / 107331077828` passed with 2834/2834 tests. M07 implementation is canonical on main. Durable closure still requires this post-merge reconciliation to be independently audited, merged and exact-main validated before M08 advances.

## ADR-0042 - M08 planning frozen, merged and exact-main validated
Status: `APPROVED`
M08 Microbenchmark Lab & Capability Envelope completed S01-S05 planning, Final Technology Review and the M09-M60 Forward Compatibility Scan. The independent final planning audit approved `m08-contract-v1.0` with 330 hard invariants, 40 independent mandatory technology surfaces, 15 mandatory absorbed components, 52/52 downstream modules scanned and zero residual HIGH/CRITICAL findings. Approved head `f6ac4feee869bedaa9df34de113d06e6966d2440` passed Governance `35907668353 / 107339306266`. PR #56 was squash-merged as `5303788f60dc0591fab350270e6b9fe02ac7a45a`; exact-main Governance `35907947242` passed. This records planning truth only. M08 implementation remains blocked until this reconciliation is merged/exact-main validated and a separate bounded Work Order / Context Lock / Evidence package is admitted.


## ADR-0043 - M08 implementation merged and exact-main validated
Status: `APPROVED`
IRIS-WO-0012 implemented the frozen `m08-contract-v1.0` Microbenchmark Lab & Capability Envelope kernel. Independent audit initially found two HIGH findings and one MEDIUM finding: absence of a real bounded active-measurement path, proof mapping that established target existence without invariant-level semantic proof integrity, and incomplete PR file accounting. Correction Delta 01 closed all three. Final audited head `33799162aad92d34689b923f43aed81ac17555de` passed Governance `35927184243 / 107404947552` with 385 focused M08 tests, 3219/3219 full-suite tests and zero residual CRITICAL/HIGH/MEDIUM findings. PR #59 was squash-merged as `ea419f2b45209b2371fd18533dc60e3daa126fab`; exact-main Governance `35976118079 / 107556893726` passed. M08 implementation is canonical on main. Durable closure requires this post-merge reconciliation to be independently audited, protected-merged and exact-main validated before M09 planning begins.


## ADR-0044 - M09 implementation merged and exact-main validated
Status: `APPROVED`
IRIS-WO-0013 implemented frozen `m09-contract-v1.0` with 83/83 surfaces, 15/15 absorbed components, 514/514 hard-invariant proofs and FC-09-01..14. The implementation qualification recorded 721 focused M09 tests and 3940/3940 full-suite tests at head `15ac24b117c954c0ad6cebd1b618b745858d30b5`; exact audited PR head `e52d3fdafe5ac142d41b35f45a768f7f8840dd74` passed Governance `36008582172 / 107663068489` and independent audit approved it. PR #65 was merged to `main` as `d4ebf87c266d6de04a4e978fa6b8ad8fa958618c`; exact-main Governance `36016789990 / 107691278049` passed. M09 is durably closed. M10 remains NOT ADMITTED and NOT STARTED until this closure reconciliation is independently reviewed, protected-merged and exact-main validated.

## ADR-0045 - M09 closure reconciliation validated; M10 planning is next
Status: `APPROVED`
PR #66's final head `8c1fe7ff4b3ad8da74194ee15d5466341b578025` passed exact-head Governance (36025800675 / 107721889592), was protected squash-merged as `e8ab43f42981630bad244a1d932e60e4ac584b2e`, and passed exact-main Governance (36027974675 / 107729242412). M09 implementation and closure reconciliation are durably complete. M10 — Adaptive Execution Planner & Predictive OOM/Thermal Shield — is eligible to begin a separately governed planning lifecycle. M10 implementation remains NOT ADMITTED and NOT STARTED until its planning cycle, contract, reviews and separate implementation admission gates pass.
