...
## Next-module rule
M05 planning starts from the 2677-test exact-main baseline. S01-S05 define future proof obligations around persistent identity, immutable revisions, family/profile/component identity, cross-modal pinned links, anchor/mutation/drift semantics, semantic lineage distinct from M02 branches, directional multi-axis compatibility, explicit migration loss/defaults, package-vs-subject identity separation, dependency closure, staged import admission, collision-safe import, rights/security/storage/delivery authority firewalls, deterministic conformance reporting and non-executable fail-closed package supply chain. Concrete M05 implementation tests are not admitted until contract freeze.
