...
## Next-module rule
M05 planning starts from the 2677-test exact-main baseline. S01-S03 define future proof obligations around persistent identity, immutable DNA revisioning, trait criticality/mutability, family/profile/component identity, CLASS/ARCHETYPE/INDIVIDUAL/VARIANT separation, persistent/contextual appearance, product/environment identity levels, revision-pinned MotionDNA/VoiceDNA/BrandDNA links, stale-link detection, campaign-vs-brand authority, SceneIdentityDNA-vs-SceneIR/Canon firewalls, cross-modal required-link preservation and anti-auto-merge safety. Concrete M05 implementation tests are not admitted until contract freeze.
