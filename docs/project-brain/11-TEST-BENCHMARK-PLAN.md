...
## Next-module rule
M05 planning starts from the 2677-test exact-main baseline. S01-S04 define future proof obligations around persistent identity, immutable revisions, family/profile/component identity, cross-modal pinned links, explicit anchor authority, typed multi-dimensional drift evidence, no-single-score identity decisions, missing-evidence safety, repair-vs-mutation separation, policy-bound mutation admission, same-identity revisioning, identity break/split/consolidation lineage, M39 root-identity firewall and privacy-minimized protected evidence. Concrete M05 implementation tests are not admitted until contract freeze.
