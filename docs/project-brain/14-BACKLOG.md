...
M11 S05 cancellation, timeout, crash recovery and workstation coexistence planning is proposed as a separate documentation increment on branch iris-wo-0015-m11-s05-cancellation-recovery-20260926. The planning PR must stay open after exact-head Governance; HEDS, merge, S05 closeout, Final Technology Review, Forward Compatibility Scan, contract candidate/audit/freeze and implementation admission remain separate later gates. M12-M60 owner-specific interfaces remain pending. M11 implementation remains NOT_ADMITTED; M10 implementation preflight remains BLOCKED.
